...
parser.add_argument('--save', type=str, default='data\ImageNet', help='experiment name')
parser.add_argument('--seed', type=int, default=0, help='random seed')
#parser.add_argument('--arch', type=int, default=0, help='which architecture to use')
parser.add_argument('--grad_clip', type=float, default=5., help='gradient clipping')
parser.add_argument('--label_smooth', type=float, default=0.1, help='label smoothing')
parser.add_argument('--lr_scheduler', type=str, default='cosine', help='lr scheduler, linear or cosine')
parser.add_argument('--tmp_data_dir', type=str, default='log', help='temp data dir')
...
def main():
    ...
    normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406],std=[0.2023,0.1994,0.262])
...
#    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, args.decay_period, gamma=args.gamma)
    ...
    for epoch in range(args['epochs']):
        ...
        nni.report_intermediate_result(valid_acc_top1)
